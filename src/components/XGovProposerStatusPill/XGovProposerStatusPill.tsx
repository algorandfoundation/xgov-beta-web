...
import { CheckIcon, CircleDashedIcon, ClockAlertIcon, XIcon } from "lucide-react";

export interface XGovProposerStatusPill {
    proposer?: { isProposer: boolean } & ProposerBoxState;
}

export default function XGovProposerStatusPill({ proposer }: XGovProposerStatusPill) {
    const validKYC =
        (
            proposer
            && proposer.kycStatus
