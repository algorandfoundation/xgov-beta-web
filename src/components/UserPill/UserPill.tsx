    ...
    "group flex items-center rounded-full px-2.5 py-[3px] z-10",
    {
        variants: {
            variant: {
                ...
                secondary: "bg-algo-blue/10 dark:bg-algo-teal/10 hover:bg-algo-blue dark:hover:bg-algo-teal text-algo-blue dark:text-white hover:text-white dark:hover:text-algo-black"
            },
        },
        defaultVariants: {
            variant: "default"
