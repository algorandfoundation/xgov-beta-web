...
export default function LoraPillLink({ id }: { id: bigint }) {
    return (
        <Link
            ...
            className="group w-fit flex items-center bg-algo-blue/10 dark:bg-algo-teal/10 hover:bg-algo-blue dark:hover:bg-algo-teal text-algo-blue dark:text-white hover:text-white dark:hover:text-algo-black rounded-full max-w-3xl px-3 py-[3px] transition z-10"
        >
            {Number(id)}
