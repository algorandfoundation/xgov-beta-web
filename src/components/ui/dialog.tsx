...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn(
      "text-left text-sm text-slate-500 dark:text-slate-400",
      className,
    )}
    {...props}
  />
