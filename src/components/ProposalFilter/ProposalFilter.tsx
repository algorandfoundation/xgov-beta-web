...
import { FocusReverseMap, ProposalFundingTypeReverseMap, ProposalStatusFilterKeys } from "@/types/proposals";
                ...
                <Dialog open={dialogOpen}>
                    ...
                    >
                        <DialogHeader className="mt-12 flex flex-col items-start gap-2">
                            <DialogTitle className="dark:text-white">Filter Proposals</DialogTitle>
                            <DialogDescription>
                                Filter proposals by status, type, requested amount, and category.
                            </DialogDescription>
                        </DialogHeader>
                                                    ...
                                                    <Button
                                                        ...
                                                        onClick={() => {
                                                            setSelected(prev => {
                                                                ...
                                                                const isAlreadySelected = newSelected[keyIndex] === (valueIndex + 1)
                                                                newSelected[keyIndex] = isAlreadySelected ? 0 : (valueIndex + 1)
                                                                return newSelected
                                                            });
