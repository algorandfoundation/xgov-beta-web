    ...
    <span className="flex gap-2 py-1">
      ...
      <span className="flex gap-1">
        <dt>
          ...
          <ThumbsDownIcon
            aria-hidden="true"
            className="size-4 md:size-6 stroke-[2] text-algo-black dark:text-white/60 group-hover:text-white"
          />
        </dt>
        <dd className="text-xs md:text-base text-algo-black dark:text-white/60 group-hover:text-white">
          7
        </dd>
      </span>
    </span>
